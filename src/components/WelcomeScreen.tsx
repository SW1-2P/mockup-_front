...
import { FolderPlus, File, Upload, Clock, Plus, ListTodo, Layers, Smartphone } from 'lucide-react';
...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({
  ...
  // Función para navegar a la página principal de Mobile Apps
  const handleMobileAppsMain = () => {
    navigate('/mobile-apps-main');
  };
    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <main className="flex-grow flex flex-col p-6 max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          ...
          <button
            onClick={handleMobileAppsMain}
            className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow flex items-center gap-4"
          >
            <div className="h-10 w-10 bg-gradient-to-r from-blue-100 to-green-100 rounded-full flex items-center justify-center text-blue-600">
              <Smartphone size={24} />
            </div>
            <div className="text-left">
              <h3 className="font-semibold text-gray-800">Apps Móviles</h3>
              <p className="text-sm text-gray-500">Crear y gestionar aplicaciones móviles</p>
            </div>
          </button>
        </div>
